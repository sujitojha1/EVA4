...
class dataset_cifar10:
    ...
    def __init__(self,dataset='CIFAR10',shuffle=True, sample=True):
        ...
        self.dataloaders_args = dict(shuffle=self.shuffle, batch_size=batch_size, num_workers = 4, pin_memory = True) if cuda else dict(shuffle=self.shuffle,batch_size=64)
